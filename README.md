...
```
java -jar org.hl7.fhir.validator.jar [file path] -version 4.0.1 -ig output -profile output http://fhir.ch/ig/ch-emed/StructureDefinition/ch-emed-document-medicationcard
 ```
