...
* extension[medicationStatementChanged] ^short = "Reference to the changed medication statement"
* extension[medicationRequestChanged] ^short = "Reference to the changed medication request"
* identifier 1..1
