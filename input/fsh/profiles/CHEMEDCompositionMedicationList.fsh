...
* section[list].entry[medicationDispense] only Reference(CHEMEDMedicationDispenseList)
* section[list].entry[medicationDispense] ^short = "MedicationDispense (from DIS)"
