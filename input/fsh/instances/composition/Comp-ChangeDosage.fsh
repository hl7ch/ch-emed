...
* status = #final
* type.coding[0] = $loinc#61356-2 "Medication pharmaceutical advice.extended Document" // patternCC
* type.coding[+] = $sct#419891008 "Record artifact (record artifact)" // invariant
