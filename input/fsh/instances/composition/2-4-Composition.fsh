...
* status = #final
* type.coding[0] = $loinc#60593-1 "Medication dispensed.extended Document" // patternCC
* type.coding[+] = $sct#294121000195110 "Medication dispense document (record artifact)" // invariant
