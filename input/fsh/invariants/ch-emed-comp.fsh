...
Severity: #error
Expression: "coding.where(system = 'http://loinc.org').exists() implies (coding.where(system = 'http://loinc.org').code = '77603-9')"
...
Severity: #error
Expression: "coding.where(system = 'http://loinc.org').exists() implies (coding.where(system = 'http://loinc.org').code = '60593-1')"
...
Severity: #error
Expression: "coding.where(system = 'http://loinc.org').exists() implies (coding.where(system = 'http://loinc.org').code = '57833-6')"
...
Severity: #error
Expression: "coding.where(system = 'http://loinc.org').exists() implies (coding.where(system = 'http://loinc.org').code = '61356-2')"
